...
(function() {
  ...
  SmallMultiples = function() {
    ...
    /* y-axis generator */
    yAxis = d3.svg.axis().scale(yScale).orient("left").ticks(6).outerTickSize(0).tickSubdivide(1).tickSize(-width);
    ...
    setupScales = function(data) {
     ...
     /* Use generators to make path for each plot */
    chart = function(selection) {
      return selection.each(function(rawData) {
        ...
        /* add category name label and the star and end year labels*/
  ...
  $(function() {
    ...
    queue().defer(d3.tsv, "2/data/201512_11balance evaluation copy.tsv").await(display);
